          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-justify">
                ...
                websites work, which quickly evolved into a full-fledged
                passion. I thrive on solving complex problems and turning ideas
                into reality through code. Whether it's crafting intuitive user
                interfaces or optimizing server-side performance, I approach
                each project with dedication and a keen eye for detail.
              </p>
              <p className="text-muted-foreground text-justify">
                Beyond coding, I enjoy collaborating with like-minded
                individuals and staying updated with the latest industry trends.
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                ...
                <a
                  href="/public/CV_Andy_Wijaya.pdf"
                  download="CV_Andy_Wijaya.pdf"
